...
mkdir $HOME/subspace; \
cd $HOME/subspace && \
wget https://github.com/subspace/subspace/releases/download/gemini-3f-2023-sep-11/subspace-farmer-ubuntu-x86_64-v2-gemini-3f-2023-sep-11 -O subspace-cli && \
...
mkdir $HOME/subspace; \
cd $HOME/subspace && \
wget https://github.com/subspace/subspace/releases/download/gemini-3f-2023-sep-11/subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-sep-11 -O subspace-cli && \
sudo chmod +x subspace-cli && \
sudo mv subspace-cli /usr/local/bin/ && \
cd $HOME && \
/usr/local/bin/subspace-cli init
